...
//		}
		...
		//
			...
			message.channel.send("test", {files: ["https://hypixel.net/proxy/aHR0cHM6Ly9jZG4uZGlzY29yZGFwcC5jb20vYXR0YWNobWVudHMvNTg3NzY1OTg0MDMxNTM5MjQyLzY3MjEwNDM3NjM1NzIyNDQ4OS9hOWQxM2I4YS01MGFkLTQ1MWItOWI5ZS0xOGE5YWVhZTIyOTAucG5n/image.png"]}).then(msg => {msg.delete(4000)});
			message.delete(4000);
		}
		//
		else {
