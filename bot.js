...
client.on('message', message => {
	...
	for (var i in blacklisted) {
		if (message.content.toLowerCase().includes(blacklisted[i].toLowerCase())) {
			...
			else if (blacklisted[i] == "stfu") { message.reply("vraagt u gelieve uw mondje dicht te houden en uw handjes van uw toetsenbord af te halen voor enkele seconden.").then(msg => {msg.delete(4000)}); }
