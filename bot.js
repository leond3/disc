	...
	if(message.channel.name == "discord-commands") {
		...
		message.delete(300000);
			...
			if (voiceChannel && message.member.roles.find(r => r.name === "Moderator") || message.member.roles.find(r => r.name === "Administrator")) {
				...
				message.guild.channels.get('682165828535451658').send(":green_telephone_receiver: :joost_bot: :telephone_receiver: " + message.member.user.tag + " connected to a private call.");
			}
