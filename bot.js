...
//------------------------------------------------------------------------------------------------------------------------------
	if (command === 'event' && !message.author.bot && message.member.roles.find(r => r.name === "Bot builder")) {
		var spookyfestival = Math.addition(args[0], "4900");
		var travelingzoofirst = Math.addition(args[0], "1920");
		var travelingzoosecond = Math.addition(args[0], "5640");
		var eventofthejerry = Math.addition(args[0], "7100");
		var newyear = args[0];
